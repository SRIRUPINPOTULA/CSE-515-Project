...
The file `output_task1.json` contains the sample input's and it's corresponding `10` videos with the distance measure. This is output generated by using the task-1.
