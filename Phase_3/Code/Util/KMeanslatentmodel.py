...
def PCA(feature_space):
    ...
    ##Latent Count - maximum inhenerent dimensionality obtained from Task 0a
    latent_count = 50
    ...
    # Sort the eigenvectors and get the top latent semantics
...
def KMeans_implementation(feature_matrix, s):
    ...
    for feature_matirx in feature_matrix_list:
        curr_feature = feature_matirx
        curr_dis = []
        for cluster_centre in cluster_centre_list:
            dist = euclidean(curr_feature, cluster_centre)
